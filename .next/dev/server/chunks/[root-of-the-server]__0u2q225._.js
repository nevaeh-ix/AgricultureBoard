...
"[project]/src/app/api/crops/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        const crops = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].crop.findMany({
            orderBy: {
                id: "asc"
            }
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(crops);
    } catch (error) {
        console.log(error);
...
async function POST(req) {
    try {
        ...
        const newCrop = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].crop.create({
            data: {
                name: crop.name,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0u2q225._.js.map